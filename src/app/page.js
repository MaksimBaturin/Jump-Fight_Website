            ...
            <div className={styles.content}>
                <div className={styles.description}>
                    ...
                    <p className={styles.descriptionContent}>
                        Аркадный платформер с видом сбоку в сеттинге классического фентези. Жанры - platformer, rogue-lite.
                        Главной задачей игрока является подъем по башне при помощи прыжков. Однако, помимо преодоления платформ,
                        игроку предстоит столкнуться с врагами на отдельных аренах, что представляют собой промежуточный этап
                        между прыжковыми секциями. Визуально игра выполнена в стиле пиксельной графики для лучшего погружения
            ...
            <div className={styles.content}>
                ...
                <div className={styles.description}>
                    <p className={styles.descriptionContent}>
                        ...
                        в стиле Doodle Jump и включает в себя неконтролируемый подъем по платформам,
